...
$url        = 'https://launchpad.net/veracrypt/trunk/1.23/+download/VeraCrypt%20Setup%201.23.exe'
...
$packageArgs = @{
  ...
  checksum      = '277C1BFE069A889EB752D3C630DB34310102B2BB2F0C0FF11CF4246E333B3503'
  checksumType  = 'sha256'
}
